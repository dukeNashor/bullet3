// COPIED from Extras/VHACD/test/src/main_vhacd.cpp
...
//		Points.push_back(FBX->Vertices[i][0]);
//		Points.push_back(FBX->Vertices[i][1]);
//		Points.push_back(FBX->Vertices[i][2]);
//	}
//	//
...
//	bool res = interfaceVHACD->Compute(&Points[0], 3U, (uint32_t)(Points.size() / 3),
//		&Triangles[0], 3U, (uint32_t)(Triangles.size() / 3), params);
//	//
